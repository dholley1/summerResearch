class scoreboard {
  ...
  ArrayList<Integer> inRange() {
    // anything less than low + mad
    float limit = findLow() + findMAD();
    println("low: ", findLow(), " median: ", findMedian(), " MAD: ", findMAD());
    ArrayList<Integer> withinRange = new ArrayList<Integer>();
