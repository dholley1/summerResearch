...
class Brush {
  ...
  int brushRad = (int) random(1, 2);   // initial radius of brush
  ...
  void display(float x, float y) {
    ...
    float xNow = x;
    float yNow = y;
    body.shape(this.parent, xNow, yNow);
  }
